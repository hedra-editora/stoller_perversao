...
\item \textit{A Vênus de quinze anos (Flossie)}, $[$Swinburne$]$
\item \textit{O outro lado da moeda (Teleny)}, $[$Oscar Wilde$]$
\item \textit{Poesia vaginal --- cem sonnettos sacanas}, Glauco Mattoso
\item \textit{A Vênus das peles}, Sacher"-Masoch
\item \textit{Perversão --- a forma erótica do ódio}, Robert J. Stoller
\end{enumerate}
\endgroup
...
\item \textit{A Vênus das peles}, Sacher{}-Masoch --- edição de bolso
...
\item \textit{Flossie, a Vênus de quinze anos}, [Swinburne] --- edição de bolso
\item \textit{Teleny, ou o reverso da medalha}, [Oscar Wilde] --- edição de bolso
...
\item \textit{1964: do golpe à democracia}, Angela Alonso e Miriam Dolhnikoff (org.)
\item \textit{Dicionário de mitologia nórdica}, Johnni Langer (org.)
\item \textit{Poesia vaginal --- Cem sonnettos sacanas}, Glauco Mattoso
\item \textit{A Vênus das peles}, Sacher"-Masoch
\item \textit{Perversão --- A forma erótica do ódio}, Robert J. Stoller
\end{enumerate}
